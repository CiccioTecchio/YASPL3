...
public class PreFixDec extends Stat implements Visitable {

    private IdConst id;
    private String op;

    public PreFixDec(ComplexSymbolFactory.Location left, ComplexSymbolFactory.Location right, String op, IdConst id) {
