...
public class PostFixInc  extends Stat implements Visitable {

    private IdConst id;
    private String op;

    public PostFixInc(ComplexSymbolFactory.Location left, ComplexSymbolFactory.Location right, String op, IdConst id) {
